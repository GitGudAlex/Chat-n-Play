    ...
    return(
        <div id='privacy-policy'>
            ...
            <div id = 'privacy-policy-hdm'>
                ...
                <p className="text-privacy-policy">Um die Video- und Chatfunktion während eines Spiels bereitzustellen, werden entsprechend der Dauer des Spiels die Daten vom Mikrofon und der Webcam Ihres Endgeräts verarbeitet. Sie können das Mikrofon und/ oder die Kamera jederzeit selbst über die Buttons in der Sidebar (links) abschalten. Im Chat werden Ihre Eingaben verarbeitet und mit Ihrem selbst gewählten Namen angezeigt.</p>  
                <p className="text-privacy-policy">Da dieser Server von der Hochschule der Medien gehostet wird, entnehmen Sie bitte weiteres der <a id="link-privacy-policy" href ='https://www.hdm-stuttgart.de/datenschutz'>Datenschutzerklärung der Hochschule der Medien</a>.</p>
            </div>
