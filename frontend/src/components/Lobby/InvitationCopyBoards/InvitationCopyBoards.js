    ...
    return (
        <div className='invitation-copy-clipboards'>
            ...
            <div className='invitation-wrapper'>
                ...
                <button id='copy-code-tooltip' title='Kopiert' className='invitation-button btn-primary' data-toggle="tooltip" data-placement="right" onClick={ () => copyToClipboard('invitation-input-code', 'copy-code-tooltip') }>
                    <IconContext.Provider value={{ size: '24px', color: 'white' }}>
                        <MdContentCopy />
                    </IconContext.Provider>
                </button>
